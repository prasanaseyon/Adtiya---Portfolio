/* ==================================================================
   ...
   Nothing personal is hardcoded here. Name, tagline, badges and links
   all come from data.js, so editing data.js is enough.
   ================================================================== */
  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div>
          <h5>Profiles</h5>
          {FOOTER_PROFILES.filter((p) => p.href).map((p) => (
        ...
        <div>
          ...
          {PROFILE.socials.scholar && (
            <a href={PROFILE.socials.scholar} target="_blank" rel="noopener noreferrer">
              Google Scholar <ExternalIcon size={12} />
            </a>
          )}
        </div>
      </div>
